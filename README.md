...
This result is similar to the results from committee-based congressional networks, with some differences. The results from committee-based congressional networks also state that black information leaders, information leaders who are more reachable, or involved in more and larger congressional committees to be more effective. 
